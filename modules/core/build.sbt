...
libraryDependencies ++= Seq(
  "dev.guardrail" %% "guardrail" % "0.68.0",
  "dev.guardrail" %% "guardrail-core" % "0.68.0",
  ...
  "dev.guardrail" %% "guardrail-scala-akka-http" % "0.68.0",
  ...
  "dev.guardrail" %% "guardrail-scala-support" % "0.68.0"
)
